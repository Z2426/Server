...
const MIN_WEIGHT = 0.05;  // Giới hạn tối thiểu cho mỗi nhóm
const MAX_WEIGHT = 0.6;   // Giới hạn tối đa cho mỗi nhóm
...
function updateWeights(interactions, baseWeights) {
    ...
    for (let group of GROUPS) {
        ...
        // Giới hạn trọng số tối đa và tối thiểu
    ...
    // Chuẩn hóa lại trọng số sau khi áp dụng giới hạn
...
function calculateCombinedWeights(shortTermWindow, longTermData, baseWeights, alpha = 0.7) {
    ...
    // Đảm bảo tổng trọng số bằng 1 sau khi kết hợp
